def test_predict_valid_input_returns_200(client,auth_headers):
...
def test_predict_wrong_type_returns_422(client,auth_headers):
...
def test_predict_negative_value_returns_422(client,auth_headers):
